 ...
 * Acts as anti-sorter of event-b navigator, except puts statemachines as the first elements within a machine.
 * 
 * @author vitaly
 *
 */
...
public class StatemachinesAntiSorter extends AntiSorter {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		// just move statemachines to top of other items, don't sort them amongst themselves
		if (e2 instanceof StatemachinesDomainNavigatorItem && e1 instanceof StatemachinesDomainNavigatorItem == false)
			if (((StatemachinesDomainNavigatorItem) e2).getEObject() instanceof AbstractStatemachine)
				return 1;
