 ...
 * Acts as anti-sorter of event-b navigator, except puts statemachine collection as the first element within a machine.
 * 
 * @author vitaly
 *
 */
...
public class StatemachinesAntiSorter extends AntiSorter {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		if (e2 instanceof StatemachinesDomainNavigatorItem)
