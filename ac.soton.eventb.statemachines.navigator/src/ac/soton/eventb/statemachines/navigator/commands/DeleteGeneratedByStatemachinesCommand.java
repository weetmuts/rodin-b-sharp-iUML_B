...
/**
 * Deletes all the elements generated by statemachines extension.
 * 
 * @author vitaly
 *
 */
public class DeleteGeneratedByStatemachinesCommand extends AbstractHandler {
	...
	public class DeleteGeneratedCommand extends
		...
		/**
		 * Cleand machine from generated elements.
		 * 
		 * @param machine
		 * @param generatorID
		 */
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (element instanceof IMachineRoot) {
				...
				if (file != null && file.exists()) {
					...
					try {
						Command command = new ICommandProxy(new DeleteGeneratedCommand(machineURI, StatemachinesPackage.STATEMACHINES_EXTENSION_ID));
