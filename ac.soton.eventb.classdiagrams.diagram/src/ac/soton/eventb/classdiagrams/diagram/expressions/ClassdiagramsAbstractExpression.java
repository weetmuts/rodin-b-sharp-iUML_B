package ac.soton.eventb.classdiagrams.diagram.expressions;
 ...
 * @generated
 */
public abstract class ClassdiagramsAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ClassdiagramsDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ClassdiagramsAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
