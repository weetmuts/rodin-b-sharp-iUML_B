...
public class ClassdiagramsVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case ClassEventsEditPart.VISUAL_ID:
			if (ClassdiagramsPackage.eINSTANCE.getClassEvent().isSuperTypeOf(
					domainElement.eClass())) {
				return ClassEventEditPart.VISUAL_ID;
			}
			break;
		case ClassInvariantsEditPart.VISUAL_ID:
			if (ClassdiagramsPackage.eINSTANCE.getClassInvariant()
					.isSuperTypeOf(domainElement.eClass())) {
				return ClassInvariantEditPart.VISUAL_ID;
			}
			break;
		case ClassAxiomsEditPart.VISUAL_ID:
			if (ClassdiagramsPackage.eINSTANCE.getClassAxiom().isSuperTypeOf(
					domainElement.eClass())) {
				return ClassAxiomEditPart.VISUAL_ID;
			}
			break;
		}
		return -1;
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case ClassEditPart.VISUAL_ID:
			...
			if (ClassEventsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ClassInvariantsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ClassAxiomsEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case ClassEventEditPart.VISUAL_ID:
			if (ClassEventNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ClassInvariantEditPart.VISUAL_ID:
			if (ClassInvariantNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ClassAxiomEditPart.VISUAL_ID:
			if (ClassAxiomNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ClassAttributesEditPart.VISUAL_ID:
			...
			break;
		case ClassEventsEditPart.VISUAL_ID:
			if (ClassEventEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ClassInvariantsEditPart.VISUAL_ID:
			if (ClassInvariantEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ClassAxiomsEditPart.VISUAL_ID:
			if (ClassAxiomEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
