 ...
 * @generated
 */
public class ClassdiagramsElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ClassdiagramsElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.ClassdiagramsElementChooserDialog_SelectModelElementTitle);
