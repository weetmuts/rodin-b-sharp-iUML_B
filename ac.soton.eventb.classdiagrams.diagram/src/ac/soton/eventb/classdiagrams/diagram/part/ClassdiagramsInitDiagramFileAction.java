 ...
 * @generated
 */
public class ClassdiagramsInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ClassdiagramsNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ClassdiagramEditPart.MODEL_ID));
		ClassdiagramsDiagramEditorUtil.runWizard(getShell(), wizard,
