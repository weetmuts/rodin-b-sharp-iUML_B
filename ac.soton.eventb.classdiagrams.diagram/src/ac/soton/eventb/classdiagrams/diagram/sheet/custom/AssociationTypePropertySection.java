...
public class AssociationTypePropertySection extends AbstractEnumerationPropertySection {
	...
	private Map<String, String> getAssociationTypeMap(){
		Map<String, String> associationTypeMap = new HashMap<String, String>();
	...
	protected boolean isEqual(int index) {
		return AssociationType.VALUES.get(index).equals(((Association) eObject).getAssociationType());
	}
	...
	protected Object getFeatureValue(int index) {
		return AssociationType.VALUES.get(index);
	}
