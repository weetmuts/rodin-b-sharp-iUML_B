...
public class ClassTypePropertySection extends AbstractEnumerationPropertySection {
	...
	private Map<String, String> getClassTypeMap(){
		Map<String, String> classTypeMap = new TreeMap<String, String>();
	...
	protected boolean isEqual(String selection) {
		return ((Class) eObject).getClassType().getLiteral().equals(selection);
	}
	...
	protected Object getFeatureValue(String selection) {
		return ClassType.get(selection).getValue();
	}
