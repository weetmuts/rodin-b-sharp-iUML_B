 ...
 * @generated
 */
public class AssociationFunctionalTotalEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ClassdiagramsVisualIDRegistry
						.getType(ac.soton.eventb.classdiagrams.diagram.edit.parts.AssociationFunctionalTotalEditPart.VISUAL_ID),
				new Point(0, 80));
	}
	 ...
	 * @generated
	 */
	public AssociationFunctionalTotalEditPart(View view) {
		super(view);
	}
