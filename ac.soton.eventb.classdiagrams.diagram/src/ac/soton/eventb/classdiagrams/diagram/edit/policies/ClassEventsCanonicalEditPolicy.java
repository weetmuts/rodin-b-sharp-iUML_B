 ...
 * @generated
 */
public class ClassEventsCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ClassdiagramsPackage.eINSTANCE.getClass_ClassEvents();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassEvents_7006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ClassEventEditPart.VISUAL_ID == ClassdiagramsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassEvents_7006SemanticChildren((View) getHost()
						.getModel());
