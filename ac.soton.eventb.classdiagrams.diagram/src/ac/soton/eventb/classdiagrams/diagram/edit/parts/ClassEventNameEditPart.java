 ...
 * @generated
 */
public class ClassEventNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClassEventNameEditPart(View view) {
		super(view);
	}
			...
			parser = ClassdiagramsParserProvider
					.getParser(
							...
							ClassdiagramsVisualIDRegistry
									.getType(ac.soton.eventb.classdiagrams.diagram.edit.parts.ClassEventNameEditPart.VISUAL_ID));
		}
		return parser;
	}
