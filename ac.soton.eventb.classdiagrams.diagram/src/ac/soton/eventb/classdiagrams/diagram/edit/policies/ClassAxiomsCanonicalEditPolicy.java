 ...
 * @generated
 */
public class ClassAxiomsCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ClassdiagramsPackage.eINSTANCE.getClass_ClassAxioms();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassAxioms_7008SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ClassAxiomEditPart.VISUAL_ID == ClassdiagramsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassAxioms_7008SemanticChildren((View) getHost()
						.getModel());
