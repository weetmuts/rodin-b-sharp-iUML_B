 ...
 * @generated
 */
public class ClassAttributeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClassAttributeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ClassdiagramsParserProvider
					.getParser(
							ClassdiagramsElementTypes.ClassAttribute_3021,
							getParserElement(),
							ClassdiagramsVisualIDRegistry
									.getType(ac.soton.eventb.classdiagrams.diagram.edit.parts.ClassAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
