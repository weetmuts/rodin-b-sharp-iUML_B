...
import ac.soton.eventb.classdiagrams.diagram.edit.policies.ClassAttributesCanonicalEditPolicy;
import ac.soton.eventb.classdiagrams.diagram.edit.policies.ClassAttributesItemSemanticEditPolicy;
...
public class ClassAttributesEditPart extends ListCompartmentEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ClassAttributesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ClassAttributesCanonicalEditPolicy());
	}
