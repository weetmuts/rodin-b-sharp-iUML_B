 ...
 * @generated
 */
public class ClassAxiomNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClassAxiomNameEditPart(View view) {
		super(view);
	}
			...
			parser = ClassdiagramsParserProvider
					.getParser(
							...
							ClassdiagramsVisualIDRegistry
									.getType(ac.soton.eventb.classdiagrams.diagram.edit.parts.ClassAxiomNameEditPart.VISUAL_ID));
		}
		return parser;
	}
