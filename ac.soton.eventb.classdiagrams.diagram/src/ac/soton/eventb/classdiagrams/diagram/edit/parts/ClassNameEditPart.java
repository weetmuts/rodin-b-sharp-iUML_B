 ...
 * @generated
 */
public class ClassNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = ClassdiagramsParserProvider
					.getParser(
							...
							ClassdiagramsVisualIDRegistry
									.getType(ac.soton.eventb.classdiagrams.diagram.edit.parts.ClassNameEditPart.VISUAL_ID));
		}
		return parser;
	}
