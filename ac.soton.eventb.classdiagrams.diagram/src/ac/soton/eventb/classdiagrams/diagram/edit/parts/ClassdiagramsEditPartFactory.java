	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case AssociationFunctionalTotalEditPart.VISUAL_ID:
				return new AssociationFunctionalTotalEditPart(view);
