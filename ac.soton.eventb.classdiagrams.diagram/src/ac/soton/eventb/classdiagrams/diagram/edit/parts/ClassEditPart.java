...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(ClassdiagramsElementTypes.ClassSupertypes_4002);
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		} else if (relationshipType == ClassdiagramsElementTypes.ClassSupertypes_4002) {
			types.add(ClassdiagramsElementTypes.Class_2002);
		}
		return types;
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == ClassdiagramsElementTypes.ClassAttribute_3004) {
				return getChildBySemanticHint(ClassdiagramsVisualIDRegistry
						.getType(ClassAttributesEditPart.VISUAL_ID));
			}
			if (type == ClassdiagramsElementTypes.ClassEvent_3003) {
				return getChildBySemanticHint(ClassdiagramsVisualIDRegistry
						.getType(ClassEventsEditPart.VISUAL_ID));
			}
			if (type == ClassdiagramsElementTypes.ClassInvariant_3005) {
				return getChildBySemanticHint(ClassdiagramsVisualIDRegistry
						.getType(ClassInvariantsEditPart.VISUAL_ID));
			}
			if (type == ClassdiagramsElementTypes.ClassAxiom_3006) {
				return getChildBySemanticHint(ClassdiagramsVisualIDRegistry
