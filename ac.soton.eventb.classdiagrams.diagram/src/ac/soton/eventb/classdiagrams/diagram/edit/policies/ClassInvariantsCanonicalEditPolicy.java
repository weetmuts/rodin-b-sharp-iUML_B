 ...
 * @generated
 */
public class ClassInvariantsCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ClassdiagramsPackage.eINSTANCE.getClass_ClassInvariants();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassInvariants_7007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ClassInvariantEditPart.VISUAL_ID == ClassdiagramsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassInvariants_7007SemanticChildren((View) getHost()
						.getModel());
