 ...
 * @generated
 */
public class ClassAttributesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassAttributesCompartment_7006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ClassAttributeEditPart.VISUAL_ID == ClassdiagramsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassAttributesCompartment_7006SemanticChildren((View) getHost()
						.getModel());
