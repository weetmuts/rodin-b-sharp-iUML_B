 ...
 * @generated
 */
public class ClassAttributeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ClassAttributeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ClassAttributeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClassAttributeNameEditPart) {
			((ClassAttributeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureAttributeLabel());
			return true;
		}
		return false;
	}
