 ...
 * @generated
 */
public class ClassConstraintEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClassConstraintEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ClassConstraintItemSemanticEditPolicy());
			...
			parser = ClassdiagramsParserProvider
					.getParser(
							...
							ClassdiagramsVisualIDRegistry
									.getType(ac.soton.eventb.classdiagrams.diagram.edit.parts.ClassConstraintEditPart.VISUAL_ID));
		}
		return parser;
	}
	 ...
	 * @generated
	 */
	public class ConstraintFigure extends WrappingLabel {
