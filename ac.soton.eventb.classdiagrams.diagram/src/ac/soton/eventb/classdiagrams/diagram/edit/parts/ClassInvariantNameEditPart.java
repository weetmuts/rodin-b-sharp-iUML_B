 ...
 * @generated
 */
public class ClassInvariantNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClassInvariantNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ClassdiagramsTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ClassdiagramEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ClassdiagramsParserProvider
					.getParser(
							ClassdiagramsElementTypes.ClassInvariant_3005,
							getParserElement(),
							ClassdiagramsVisualIDRegistry
									.getType(ac.soton.eventb.classdiagrams.diagram.edit.parts.ClassInvariantNameEditPart.VISUAL_ID));
		}
		return parser;
	}
