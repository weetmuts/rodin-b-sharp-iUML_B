 ...
 * @generated
 */
public class AssociationTotalFunctionalEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ClassdiagramsVisualIDRegistry
						.getType(ac.soton.eventb.classdiagrams.diagram.edit.parts.AssociationTotalFunctionalEditPart.VISUAL_ID),
				new Point(8, -5));
	}
	 ...
	 * @generated
	 */
	public AssociationTotalFunctionalEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ClassdiagramEditPart.LinkLabelDragPolicy());
	}
