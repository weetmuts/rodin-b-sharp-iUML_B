 ...
 * @generated
 */
public class ClassSupertypesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ClassSupertypesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ClassdiagramsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateClassSupertypes_4006(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSupertypes().add(getTarget());
		}
