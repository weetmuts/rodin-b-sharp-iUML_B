...
import ac.soton.eventb.classdiagrams.diagram.edit.commands.ClassCreateCommand;
import ac.soton.eventb.classdiagrams.diagram.providers.ClassdiagramsElementTypes;

/**
 * @generated
 */
public class ClassdiagramItemSemanticEditPolicy extends
	...
	public ClassdiagramItemSemanticEditPolicy() {
		super(ClassdiagramsElementTypes.Classdiagram_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (ClassdiagramsElementTypes.Class_2003 == req.getElementType()) {
