...
import ac.soton.eventb.classdiagrams.diagram.part.ClassdiagramsDiagramEditorUtil;

/**
 * @generated
 */
public class ClassdiagramsMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ClassdiagramsDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ClassdiagramsDiagramEditorUtil.selectElementsInDiagram(editor,
