...
public class ClassdiagramsParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser classAttributeName_5003Parser;

	/**
	 * @generated
	 */
	private IParser getClassAttributeName_5003Parser() {
		if (classAttributeName_5003Parser == null) {
			EAttribute[] features = new EAttribute[] { CorePackage.eINSTANCE
					.getEventBNamed_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			classAttributeName_5003Parser = parser;
		}
		return classAttributeName_5003Parser;
	}

	/**
	 * @generated
	 */
	private IParser classEventName_5002Parser;

	/**
	 * @generated
	 */
	private IParser getClassEventName_5002Parser() {
		if (classEventName_5002Parser == null) {
			EAttribute[] features = new EAttribute[] { CorePackage.eINSTANCE
					.getEventBNamed_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			classEventName_5002Parser = parser;
		}
		return classEventName_5002Parser;
	}

	/**
	 * @generated
	 */
	private IParser classInvariantName_5004Parser;

	/**
	 * @generated
	 */
	private IParser getClassInvariantName_5004Parser() {
		if (classInvariantName_5004Parser == null) {
			EAttribute[] features = new EAttribute[] { CorePackage.eINSTANCE
					.getEventBNamed_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			classInvariantName_5004Parser = parser;
		}
		return classInvariantName_5004Parser;
	}

	/**
	 * @generated
	 */
	private IParser classAxiomName_5005Parser;

	/**
	 * @generated
	 */
	private IParser getClassAxiomName_5005Parser() {
		if (classAxiomName_5005Parser == null) {
			EAttribute[] features = new EAttribute[] { CorePackage.eINSTANCE
					.getEventBNamed_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			classAxiomName_5005Parser = parser;
		}
		return classAxiomName_5005Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case ClassAttributeNameEditPart.VISUAL_ID:
			return getClassAttributeName_5003Parser();
		case ClassEventNameEditPart.VISUAL_ID:
			return getClassEventName_5002Parser();
		case ClassInvariantNameEditPart.VISUAL_ID:
			return getClassInvariantName_5004Parser();
		case ClassAxiomNameEditPart.VISUAL_ID:
			return getClassAxiomName_5005Parser();
