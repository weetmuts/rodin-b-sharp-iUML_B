 ...
 * @generated
 */
public class ClassdiagramsViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ClassdiagramsVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ClassdiagramsVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!ClassdiagramsElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != ClassdiagramsVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!ClassdiagramEditPart.MODEL_ID
						.equals(ClassdiagramsVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return ClassEditPart.VISUAL_ID == visualID
				|| ClassAttributeEditPart.VISUAL_ID == visualID
				|| ClassEventEditPart.VISUAL_ID == visualID
				|| ClassInvariantEditPart.VISUAL_ID == visualID
				|| ClassAxiomEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ClassdiagramsVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = ClassdiagramsVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ClassEditPart.VISUAL_ID:
		...
		case ClassAttributeEditPart.VISUAL_ID:
			return createClassAttribute_3004(domainElement, containerView,
					index, persisted, preferencesHint);
		case ClassEventEditPart.VISUAL_ID:
			return createClassEvent_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case ClassInvariantEditPart.VISUAL_ID:
			return createClassInvariant_3005(domainElement, containerView,
					index, persisted, preferencesHint);
		case ClassAxiomEditPart.VISUAL_ID:
			return createClassAxiom_3006(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ClassdiagramsVisualIDRegistry.getVisualID(elementTypeHint)) {
		case AssociationEditPart.VISUAL_ID:
			return createAssociation_4001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case ClassSupertypesEditPart.VISUAL_ID:
			return createClassSupertypes_4002(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createClass_2002(EObject domainElement, View containerView,
		...
		node.setType(ClassdiagramsVisualIDRegistry
		...
		createCompartment(node,
				ClassdiagramsVisualIDRegistry
						.getType(ClassAttributesEditPart.VISUAL_ID), true,
				true, true, true);
		createCompartment(node,
				ClassdiagramsVisualIDRegistry
						.getType(ClassEventsEditPart.VISUAL_ID), true, true,
				true, true);
		createCompartment(node,
				ClassdiagramsVisualIDRegistry
						.getType(ClassInvariantsEditPart.VISUAL_ID), true,
				true, true, true);
		createCompartment(node,
				ClassdiagramsVisualIDRegistry
						.getType(ClassAxiomsEditPart.VISUAL_ID), true, true,
				true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createClassAttribute_3004(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createClassEvent_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ClassdiagramsVisualIDRegistry
				.getType(ClassEventEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createClassInvariant_3005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ClassdiagramsVisualIDRegistry
				.getType(ClassInvariantEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createClassAxiom_3006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ClassdiagramsVisualIDRegistry
				.getType(ClassAxiomEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Edge createAssociation_4001(EObject domainElement,
		...
		edge.setType(ClassdiagramsVisualIDRegistry
		...
		Node label6002 = createLabel(
				edge,
				ClassdiagramsVisualIDRegistry
						.getType(AssociationSurjectiveInjectiveEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createClassSupertypes_4002(View containerView, int index,
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ClassdiagramEditPart.MODEL_ID.equals(ClassdiagramsVisualIDRegistry
