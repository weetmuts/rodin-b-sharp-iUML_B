 ...
 * @generated
 */
public class ClassdiagramsNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = ClassdiagramsDiagramEditorPlugin
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		if (abstractNavigatorItem instanceof ClassdiagramsNavigatorItem) {
			navigatorView = ((ClassdiagramsNavigatorItem) abstractNavigatorItem)
					.getView();
