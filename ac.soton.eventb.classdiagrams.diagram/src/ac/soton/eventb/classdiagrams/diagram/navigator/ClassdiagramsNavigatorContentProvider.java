	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ClassEditPart.VISUAL_ID: {
			...
			ClassdiagramsNavigatorGroup outgoinglinks = new ClassdiagramsNavigatorGroup(
					Messages.NavigatorGroupName_Class_2002_outgoinglinks,
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ClassdiagramsVisualIDRegistry
							.getType(ClassEventsEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					ClassdiagramsVisualIDRegistry
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ClassdiagramsVisualIDRegistry
							.getType(ClassInvariantsEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					ClassdiagramsVisualIDRegistry
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ClassdiagramsVisualIDRegistry
							.getType(ClassAxiomsEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					ClassdiagramsVisualIDRegistry
