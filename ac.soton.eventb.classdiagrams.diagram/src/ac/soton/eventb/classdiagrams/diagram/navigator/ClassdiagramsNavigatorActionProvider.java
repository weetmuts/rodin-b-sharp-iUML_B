 ...
 * @generated
 */
public class ClassdiagramsNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof ClassdiagramsNavigatorItem) {
					selectedElement = ((ClassdiagramsNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, ClassdiagramsDiagramEditor.ID);
