 ...
 * @generated
 */
public class EventbcoreInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new EventbcoreNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ProjectEditPart.MODEL_ID));
		EventbcoreDiagramEditorUtil.runWizard(getShell(), wizard,
