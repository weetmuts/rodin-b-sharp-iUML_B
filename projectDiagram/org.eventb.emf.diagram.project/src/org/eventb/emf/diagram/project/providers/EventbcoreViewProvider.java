 ...
 * @generated
 */
public class EventbcoreViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EventbcoreVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = EventbcoreVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!EventbcoreElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != EventbcoreVisualIDRegistry
		...
		return MachineEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = EventbcoreVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != EventbcoreVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = EventbcoreVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case MachineEditPart.VISUAL_ID:
			return createMachine_2001(domainElement, containerView, index,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (EventbcoreVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ContextExtendsEditPart.VISUAL_ID:
			return createContextExtends_4001(containerView, index, persisted,
					preferencesHint);
		case MachineSeesEditPart.VISUAL_ID:
			return createMachineSees_4002(containerView, index, persisted,
					preferencesHint);
		case MachineRefinesEditPart.VISUAL_ID:
			return createMachineRefines_4003(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createMachine_2001(EObject domainElement, View containerView,
		...
		node.setType(EventbcoreVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createContext_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Edge createContextExtends_4001(View containerView, int index,
		...
		edge.setType(EventbcoreVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createMachineSees_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createMachineRefines_4003(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
