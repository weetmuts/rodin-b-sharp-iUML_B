...
import org.eventb.emf.diagram.project.edit.commands.ContextCreateCommand;
import org.eventb.emf.diagram.project.edit.commands.MachineCreateCommand;
...
public class ProjectItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EventbcoreElementTypes.Machine_2001 == req.getElementType()) {
			return getGEFWrapper(new MachineCreateCommand(req));
		}
		if (EventbcoreElementTypes.Context_2002 == req.getElementType()) {
