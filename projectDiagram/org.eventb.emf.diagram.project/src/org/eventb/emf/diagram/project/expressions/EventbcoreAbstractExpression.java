 ...
 * @generated
 */
public abstract class EventbcoreAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = EventbcoreDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected EventbcoreAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
