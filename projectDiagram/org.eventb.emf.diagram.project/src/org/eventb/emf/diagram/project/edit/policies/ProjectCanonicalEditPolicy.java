...
import org.eventb.emf.diagram.project.part.EventbcoreDiagramUpdater;
import org.eventb.emf.diagram.project.part.EventbcoreLinkDescriptor;
import org.eventb.emf.diagram.project.part.EventbcoreNodeDescriptor;
...
public class ProjectCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == MachineEditPart.VISUAL_ID
	...
	private Collection<EventbcoreLinkDescriptor> collectAllLinks(View view,
		...
		case MachineEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EventbcoreDiagramUpdater
						.getMachine_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
