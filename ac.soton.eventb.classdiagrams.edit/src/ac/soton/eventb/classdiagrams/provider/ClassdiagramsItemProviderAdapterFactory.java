...
public class ClassdiagramsItemProviderAdapterFactory extends ClassdiagramsAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	...
	/**
	 * This keeps track of the one adapter used for all {@link ac.soton.eventb.classdiagrams.ClassAxiom} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ClassAxiomItemProvider classAxiomItemProvider;

	/**
	 * This creates an adapter for a {@link ac.soton.eventb.classdiagrams.ClassAxiom}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createClassAxiomAdapter() {
		if (classAxiomItemProvider == null) {
			classAxiomItemProvider = new ClassAxiomItemProvider(this);
		}

		return classAxiomItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link ac.soton.eventb.classdiagrams.ClassInvariant} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ClassInvariantItemProvider classInvariantItemProvider;

	/**
	 * This creates an adapter for a {@link ac.soton.eventb.classdiagrams.ClassInvariant}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createClassInvariantAdapter() {
		if (classInvariantItemProvider == null) {
			classInvariantItemProvider = new ClassInvariantItemProvider(this);
		}

		return classInvariantItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link ac.soton.eventb.classdiagrams.ClassEvent} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ClassEventItemProvider classEventItemProvider;

	/**
	 * This creates an adapter for a {@link ac.soton.eventb.classdiagrams.ClassEvent}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createClassEventAdapter() {
		if (classEventItemProvider == null) {
			classEventItemProvider = new ClassEventItemProvider(this);
		}

		return classEventItemProvider;
	}
	...
	public void dispose() {
		...
		if (classAxiomItemProvider != null) classAxiomItemProvider.dispose();
	...
	public static class CoreChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends CoreSwitch<Object> {
			...
			EAnnotation annotation = null;
				...
				annotation = ClassdiagramsPackage.Literals.CLASS_AXIOM.getEAnnotation("org.eventb.emf.core.extendedMetaClasses");
				if (annotation == null  || annotation.getReferences().contains(object.eClass()))
					newChildDescriptors.add
						(createChildParameter
							(CorePackage.Literals.ANNOTATION__CONTENTS,
				...
				annotation = ClassdiagramsPackage.Literals.CLASS_INVARIANT.getEAnnotation("org.eventb.emf.core.extendedMetaClasses");
				if (annotation == null  || annotation.getReferences().contains(object.eClass()))
					newChildDescriptors.add
						(createChildParameter
							(CorePackage.Literals.ANNOTATION__CONTENTS,
				...
				annotation = ClassdiagramsPackage.Literals.CLASS_EVENT.getEAnnotation("org.eventb.emf.core.extendedMetaClasses");
				if (annotation == null  || annotation.getReferences().contains(object.eClass()))
					newChildDescriptors.add
						(createChildParameter
							(CorePackage.Literals.ANNOTATION__CONTENTS,
