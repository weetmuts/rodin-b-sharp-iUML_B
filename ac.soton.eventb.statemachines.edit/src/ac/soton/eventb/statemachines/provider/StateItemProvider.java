...
/**
 * This is the item provider adapter for a {@link ac.soton.eventb.statemachines.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addRefinesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_refines_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_refines_feature", "_UI_State_type"),
				 StatemachinesPackage.Literals.STATE__REFINES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addActivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_active_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_active_feature", "_UI_State_type"),
