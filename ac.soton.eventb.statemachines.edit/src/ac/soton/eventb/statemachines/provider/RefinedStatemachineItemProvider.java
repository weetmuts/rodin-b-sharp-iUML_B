...
public class RefinedStatemachineItemProvider
	 ...
	 * @generated
	 */
	public RefinedStatemachineItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addRefinesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RefinedStatemachine_refines_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RefinedStatemachine_refines_feature", "_UI_RefinedStatemachine_type"),
				 StatemachinesPackage.Literals.REFINED_STATEMACHINE__REFINES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns RefinedStatemachine.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RefinedStatemachine"));
	}
	...
	public String getText(Object object) {
		String label = ((RefinedStatemachine)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_RefinedStatemachine_type") :
			getString("_UI_RefinedStatemachine_type") + " " + label;
	}
