 ...
 * @generated
 */
public class RefinedStateItemProvider
	 ...
	 * @generated
	 */
	public RefinedStateItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addRefinesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RefinedState_refines_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RefinedState_refines_feature", "_UI_RefinedState_type"),
				 StatemachinesPackage.Literals.REFINED_STATE__REFINES,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RefinedState"));
	}
	...
	public String getText(Object object) {
		String label = ((RefinedState)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_RefinedState_type") :
			getString("_UI_RefinedState_type") + " " + label;
	}
