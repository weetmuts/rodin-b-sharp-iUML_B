...
/**
 * Classdiagram refiner extension to a standard refinement process.
 * 
 * @author vitaly
 *
 */
public class ClassdiagramMachineRefiner implements IRefinementParticipant {
	 ...
	 * Constructor.
	 */
	public ClassdiagramMachineRefiner() {
	 ...
	 * @throws RodinDBException 
	 */
	private void refineClassdiagramExtensions(IMachineRoot target,
			IMachineRoot source, IProgressMonitor monitor)
			throws RodinDBException {
