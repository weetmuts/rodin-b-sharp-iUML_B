...
public class AssociationImpl extends EventBNamedCommentedElementImpl implements Association {
	...
	public void setTarget(ac.soton.eventb.classdiagrams.Class newTarget) {
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, ClassdiagramsPackage.CLASS__SOURCE, ac.soton.eventb.classdiagrams.Class.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, ClassdiagramsPackage.CLASS__SOURCE, ac.soton.eventb.classdiagrams.Class.class, msgs);
