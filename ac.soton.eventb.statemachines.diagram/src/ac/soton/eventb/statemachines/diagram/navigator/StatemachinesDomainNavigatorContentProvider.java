 ...
 * @generated
 */
public class StatemachinesDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public StatemachinesDomainNavigatorContentProvider() {
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new StatemachinesDomainNavigatorItem(
