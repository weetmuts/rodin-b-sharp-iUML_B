 ...
 * @generated
 */
public class StatemachinesNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof StatemachinesNavigatorItem) {
					selectedElement = ((StatemachinesNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, StatemachinesDiagramEditor.ID);
