 ...
 * @generated
 */
public class StatemachinesDomainNavigatorLabelProvider implements
	...
	public Image getImage(Object element) {
		if (element instanceof StatemachinesDomainNavigatorItem) {
			return myAdapterFactoryLabelProvider
					.getImage(((StatemachinesDomainNavigatorItem) element)
							.getEObject());
		}
		return null;
	}
	...
	public String getText(Object element) {
		if (element instanceof StatemachinesDomainNavigatorItem) {
			return myAdapterFactoryLabelProvider
					.getText(((StatemachinesDomainNavigatorItem) element)
							.getEObject());
		}
		return null;
	}
