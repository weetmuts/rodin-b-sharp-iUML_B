 ...
 * @generated
 */
public class StatemachinesNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = StatemachinesDiagramEditorPlugin
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		if (abstractNavigatorItem instanceof StatemachinesNavigatorItem) {
			navigatorView = ((StatemachinesNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof StatemachinesNavigatorItem) {
				navigatorView = ((StatemachinesNavigatorItem) navigatorGroup
						.getParent()).getView();
