 ...
 * @generated
 */
public class StatemachinesMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = StatemachinesDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			StatemachinesDiagramEditorUtil.selectElementsInDiagram(editor,
