...
public class DataKindPropertySection extends AbstractEnumerationPropertySection {
	...
	protected boolean isEqual(int index) {
		return ((EventBDataElaboration) eObject).getDataKind().getLiteral().equals(getFeatureValue(index));
	}
...
//	}
	...
	private static String[] dataKindValues = null;
	
	@Override
	protected String[] getEnumerationFeatureValues() {
		if (dataKindValues == null){
			List<String> dataKinds = new ArrayList<String>();
			for (DataKind dk : DataKind.VALUES){
				dataKinds.add(dk.getLiteral());
			}
			dataKinds = filterDataKinds(dataKinds);
			dataKindValues =  dataKinds.toArray(new String[dataKinds.size()]);
			}
		return dataKindValues;
	}
	...
	@Override
	protected String getFeatureValue(int index) {
