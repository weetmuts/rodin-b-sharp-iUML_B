...
/**
 * Exit Actions property section for State.
 * 
 * @author cfs
 *
 */
public class ExitActionsPropertySection extends AbstractEditTableWithDefaultNamingPropertySection {
	...
	protected EReference getFeature() {
		return StatemachinesPackage.Literals.STATE__EXIT_ACTIONS;
	}
