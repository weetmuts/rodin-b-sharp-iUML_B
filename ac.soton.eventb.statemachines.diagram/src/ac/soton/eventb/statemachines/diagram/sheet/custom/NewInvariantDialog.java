 ...
 *
 */
public class NewInvariantDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	protected NewInvariantDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("Add New Invariant");
	}
	...
	protected void okPressed() {
		invariant = MachineFactory.eINSTANCE.createInvariant();
		
		invariant.setPredicate(predicateText.getText().trim());
		invariant.setName(nameText.getText().trim());
		invariant.setComment(commentText.getText());
		invariant.setTheorem(theoremButton.getSelection());
