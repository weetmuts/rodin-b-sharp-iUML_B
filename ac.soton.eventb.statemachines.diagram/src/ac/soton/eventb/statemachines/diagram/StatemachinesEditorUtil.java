...
public class StatemachinesEditorUtil {
	 ...
	 * @param statemachine statemachine domain element
	 * @return statemachine diagram file name string
	 */
	public static String getDiagramFileName(IPath containerFullPath, Statemachine statemachine) {
		Machine machine = (Machine) statemachine.getContaining(MachinePackage.eINSTANCE.getMachine());
		String machineName = machine != null ? machine.getName() : "";
		
		String smName = statemachine.getName();
