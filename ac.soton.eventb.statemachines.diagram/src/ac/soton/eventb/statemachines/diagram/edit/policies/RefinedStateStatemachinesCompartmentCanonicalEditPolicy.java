 ...
 * @generated
 */
public class RefinedStateStatemachinesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return StatemachinesPackage.eINSTANCE
				.getStatemachineOwner_Statemachines();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getRefinedStateRefinedStateStatemachinesCompartment_7006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == RefinedStatemachineEditPart.VISUAL_ID
				|| visualID == RefinedStateStatemachineEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getRefinedStateRefinedStateStatemachinesCompartment_7006SemanticChildren((View) getHost()
						.getModel());
