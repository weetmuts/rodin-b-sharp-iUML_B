 ...
 * @generated
 */
public class InnerStateNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InnerStateNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RootStatemachineEditPart.NodeLabelDragPolicy());
	}
			...
			parser = StatemachinesParserProvider
					.getParser(
							...
							StatemachinesVisualIDRegistry
									.getType(ac.soton.eventb.statemachines.diagram.edit.parts.InnerStateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
