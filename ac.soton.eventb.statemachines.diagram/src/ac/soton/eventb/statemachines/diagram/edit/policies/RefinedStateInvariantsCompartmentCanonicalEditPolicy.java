 ...
 * @generated
 */
public class RefinedStateInvariantsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getRefinedStateRefinedStateInvariantsCompartment_7007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getRefinedStateRefinedStateInvariantsCompartment_7007SemanticChildren((View) getHost()
						.getModel());
