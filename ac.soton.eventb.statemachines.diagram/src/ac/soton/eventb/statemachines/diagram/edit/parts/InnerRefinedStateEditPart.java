 ...
 * @generated
 */
public class InnerRefinedStateEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InnerRefinedStateEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InnerRefinedStateItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InnerRefinedStateLabelEditPart) {
			((InnerRefinedStateLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRefinedStateLabelFigure());
			return true;
		}
		if (childEditPart instanceof InnerRefinedStateStatemachinesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRefinedStateStatemachinesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InnerRefinedStateStatemachinesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof InnerRefinedStateInvariantsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRefinedStateInvariantsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InnerRefinedStateInvariantsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InnerRefinedStateStatemachinesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRefinedStateStatemachinesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((InnerRefinedStateStatemachinesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof InnerRefinedStateInvariantsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRefinedStateInvariantsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((InnerRefinedStateInvariantsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof InnerRefinedStateStatemachinesCompartmentEditPart) {
			return getPrimaryShape()
					.getFigureRefinedStateStatemachinesCompartmentFigure();
		}
		if (editPart instanceof InnerRefinedStateInvariantsCompartmentEditPart) {
			return getPrimaryShape()
					.getFigureRefinedStateInvariantsCompartmentFigure();
		}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ac.soton.eventb.statemachines.diagram.edit.parts.InnerRefinedStateEditPart) {
			types.add(StatemachinesElementTypes.Transition_4001);
		}
		if (targetEditPart instanceof InitialEditPart) {
			types.add(StatemachinesElementTypes.Transition_4002);
