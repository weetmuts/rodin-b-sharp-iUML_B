 ...
 * @generated
 */
public class InnerRefinedStateInvariantsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return StatemachinesPackage.eINSTANCE.getAbstractState_Constraints();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getRefinedStateRefinedStateInvariantsCompartment_7010SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return RefinedStateInvariantEditPart.VISUAL_ID == StatemachinesVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getRefinedStateRefinedStateInvariantsCompartment_7010SemanticChildren((View) getHost()
						.getModel());
