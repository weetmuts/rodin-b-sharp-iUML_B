 ...
 * @generated
 */
public class TransitionGhostLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				StatemachinesVisualIDRegistry
						.getType(ac.soton.eventb.statemachines.diagram.edit.parts.TransitionGhostLabelEditPart.VISUAL_ID),
				new Point(-8, -8));
	}
	 ...
	 * @generated
	 */
	public TransitionGhostLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RootStatemachineEditPart.LinkLabelDragPolicy());
	}
