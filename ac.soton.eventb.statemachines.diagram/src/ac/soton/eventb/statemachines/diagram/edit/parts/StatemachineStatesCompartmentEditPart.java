...
public class StatemachineStatesCompartmentEditPart extends
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == StatemachinesElementTypes.Initial_3011) {
				return this;
			}
			if (type == StatemachinesElementTypes.Final_3012) {
				return this;
			}
			if (type == StatemachinesElementTypes.State_3013) {
				return this;
			}
			if (type == StatemachinesElementTypes.Junction_3015) {
				return this;
			}
			if (type == StatemachinesElementTypes.Any_3016) {
				return this;
			}
			if (type == StatemachinesElementTypes.Fork_3017) {
				return this;
			}
			...
			if (RequestConstants.REQ_CONNECTION_END.equals(request.getType())) {
				for (Object type : ((CreateUnspecifiedTypeConnectionRequest) request)
					...
					if (type instanceof IElementType) {
						...
						if (elementType
								.equals(StatemachinesElementTypes.Transition_4001)
								|| elementType
