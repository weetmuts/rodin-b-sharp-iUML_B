 ...
 * @generated
 */
public class RefinedStateStatemachineNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RefinedStateStatemachineNameEditPart(View view) {
		super(view);
	}
			...
			parser = StatemachinesParserProvider
					.getParser(
							...
							StatemachinesVisualIDRegistry
									.getType(ac.soton.eventb.statemachines.diagram.edit.parts.RefinedStateStatemachineNameEditPart.VISUAL_ID));
		}
		return parser;
	}
