...
import ac.soton.eventb.statemachines.diagram.edit.policies.RefinedStateStatemachinesCompartmentCanonicalEditPolicy;
import ac.soton.eventb.statemachines.diagram.edit.policies.RefinedStateStatemachinesCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RefinedStateStatemachinesCompartmentEditPart extends
	 ...
	 * @generated
	 */
	public RefinedStateStatemachinesCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.RefinedStateStatemachinesCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new RefinedStateStatemachinesCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RefinedStateStatemachinesCompartmentCanonicalEditPolicy());
		installEditPolicy(
