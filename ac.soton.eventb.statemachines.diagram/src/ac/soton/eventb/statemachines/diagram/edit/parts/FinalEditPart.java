...
import ac.soton.eventb.statemachines.diagram.edit.policies.FinalItemSemanticEditPolicy;
...
public class FinalEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ac.soton.eventb.statemachines.diagram.edit.parts.FinalEditPart) {
			types.add(StatemachinesElementTypes.Transition_4001);
		}
