 ...
 * @generated
 */
public class RefinedStatemachineLabelEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RefinedStatemachineLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StatemachinesParserProvider
					.getParser(
							StatemachinesElementTypes.RefinedStatemachine_3007,
							getParserElement(),
							StatemachinesVisualIDRegistry
									.getType(ac.soton.eventb.statemachines.diagram.edit.parts.RefinedStatemachineLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
