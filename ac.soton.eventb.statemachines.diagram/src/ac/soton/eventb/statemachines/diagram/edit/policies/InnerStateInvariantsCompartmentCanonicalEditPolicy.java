 ...
 * @generated
 */
public class InnerStateInvariantsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getStateStateInvariantsCompartment_7015SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return InvariantEditPart.VISUAL_ID == StatemachinesVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getStateStateInvariantsCompartment_7015SemanticChildren((View) getHost()
						.getModel());
