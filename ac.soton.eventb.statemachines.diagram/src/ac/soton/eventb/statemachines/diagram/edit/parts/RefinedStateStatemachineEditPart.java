...
import ac.soton.eventb.statemachines.diagram.edit.policies.RefinedStateStatemachineItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RefinedStateStatemachineEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RefinedStateStatemachineEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RefinedStateStatemachineItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof StatemachineStatesCompartment2EditPart) {
			...
			pane.add(((StatemachineStatesCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof StatemachineStatesCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureStatemachineCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((StatemachineStatesCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ac.soton.eventb.statemachines.diagram.edit.parts.RefinedStateStatemachineEditPart) {
			types.add(StatemachinesElementTypes.Transition_4002);
		}
		return types;
	}
	...
	public class StatemachineFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureStatemachineNameFigure.setBorder(new MarginBorder(
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 224, 255, 204);
