 ...
 * @generated
 */
public class TransitionGhostNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				StatemachinesVisualIDRegistry
						.getType(ac.soton.eventb.statemachines.diagram.edit.parts.TransitionGhostNameEditPart.VISUAL_ID),
				new Point(-5, -5));
	}
	 ...
	 * @generated
	 */
	public TransitionGhostNameEditPart(View view) {
		super(view);
	}
