 ...
 * @generated
 */
public class StateInvariantEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StateInvariantItemSemanticEditPolicy());
			...
			parser = StatemachinesParserProvider
					.getParser(
							...
							StatemachinesVisualIDRegistry
									.getType(ac.soton.eventb.statemachines.diagram.edit.parts.StateInvariantEditPart.VISUAL_ID));
		}
		return parser;
	}
