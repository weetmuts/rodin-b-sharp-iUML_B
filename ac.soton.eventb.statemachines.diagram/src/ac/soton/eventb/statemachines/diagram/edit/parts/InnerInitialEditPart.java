...
import ac.soton.eventb.statemachines.diagram.edit.policies.InnerInitialItemSemanticEditPolicy;
import ac.soton.eventb.statemachines.diagram.providers.StatemachinesElementTypes;

/**
 * @generated
 */
public class InnerInitialEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InnerInitialEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InnerInitialItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ac.soton.eventb.statemachines.diagram.edit.parts.InnerInitialEditPart) {
			types.add(StatemachinesElementTypes.Transition_4001);
		}
