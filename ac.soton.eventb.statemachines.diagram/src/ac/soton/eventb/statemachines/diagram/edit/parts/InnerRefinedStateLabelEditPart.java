 ...
 * @generated
 */
public class InnerRefinedStateLabelEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public InnerRefinedStateLabelEditPart(View view) {
		super(view);
	}
			...
			parser = StatemachinesParserProvider
					.getParser(
							...
							StatemachinesVisualIDRegistry
									.getType(ac.soton.eventb.statemachines.diagram.edit.parts.InnerRefinedStateLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
