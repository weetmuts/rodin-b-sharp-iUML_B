 ...
 * @generated
 */
public class InnerANYEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InnerANYEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InnerANYItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ANYFigure();
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ac.soton.eventb.statemachines.diagram.edit.parts.InnerANYEditPart) {
			types.add(StatemachinesElementTypes.Transition_4001);
		}
	...
	public class ANYFigure extends Ellipse {
		...
		private void createContents() {
			...
			PolygonShape eighthornFigureShape0 = new PolygonShape();
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(10),
					getMapMode().DPtoLP(0)));
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(12),
					getMapMode().DPtoLP(5)));
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(17),
					getMapMode().DPtoLP(3)));
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(15),
					getMapMode().DPtoLP(8)));
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(20),
			...
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(8),
					getMapMode().DPtoLP(15)));
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(3),
					getMapMode().DPtoLP(17)));
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(5),
					getMapMode().DPtoLP(12)));
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(10)));
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(5),
					getMapMode().DPtoLP(8)));
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(3),
			...
			eighthornFigureShape0.addPoint(new Point(getMapMode().DPtoLP(10),
					getMapMode().DPtoLP(0)));
			eighthornFigureShape0.setFill(true);
			eighthornFigureShape0.setOutline(false);
			eighthornFigureShape0.setBackgroundColor(ColorConstants.white);

			this.add(eighthornFigureShape0);
