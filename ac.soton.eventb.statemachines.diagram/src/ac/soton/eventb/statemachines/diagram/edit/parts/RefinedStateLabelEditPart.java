 ...
 * @generated
 */
public class RefinedStateLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RefinedStateLabelEditPart(View view) {
		super(view);
	}
			...
			parser = StatemachinesParserProvider
					.getParser(
							...
							StatemachinesVisualIDRegistry
									.getType(ac.soton.eventb.statemachines.diagram.edit.parts.RefinedStateLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
