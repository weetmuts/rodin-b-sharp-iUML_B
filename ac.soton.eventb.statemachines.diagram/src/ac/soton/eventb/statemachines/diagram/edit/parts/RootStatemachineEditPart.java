 ...
 * @generated
 */
public class RootStatemachineEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Statemachines"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public RootStatemachineEditPart(View view) {
		super(view);
	}
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new StatemachinesCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
