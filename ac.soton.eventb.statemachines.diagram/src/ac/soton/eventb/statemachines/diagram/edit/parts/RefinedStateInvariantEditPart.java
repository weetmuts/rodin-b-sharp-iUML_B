...
import ac.soton.eventb.statemachines.diagram.edit.policies.RefinedStateInvariantItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RefinedStateInvariantEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RefinedStateInvariantEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RefinedStateInvariantItemSemanticEditPolicy());
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof StatemachinesTextSelectionEditPolicy) {
			((StatemachinesTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof StatemachinesTextSelectionEditPolicy) {
			((StatemachinesTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
			...
			parser = StatemachinesParserProvider
					.getParser(
							...
							StatemachinesVisualIDRegistry
									.getType(ac.soton.eventb.statemachines.diagram.edit.parts.RefinedStateInvariantEditPart.VISUAL_ID));
		}
		return parser;
	}
