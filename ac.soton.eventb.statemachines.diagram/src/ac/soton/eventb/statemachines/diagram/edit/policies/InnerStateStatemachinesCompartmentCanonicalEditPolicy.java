 ...
 * @generated
 */
public class InnerStateStatemachinesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getStateStateStatemachinesCompartment_7014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StatemachinesNodeDescriptor> childDescriptors = StatemachinesDiagramUpdater
				.getStateStateStatemachinesCompartment_7014SemanticChildren((View) getHost()
						.getModel());
