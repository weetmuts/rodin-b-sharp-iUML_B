 ...
 * @generated
 */
public class ForkEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ForkItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ac.soton.eventb.statemachines.diagram.edit.parts.ForkEditPart) {
			types.add(StatemachinesElementTypes.Transition_4001);
		}
