 ...
 * @generated
 */
public abstract class StatemachinesAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = StatemachinesDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected StatemachinesAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
