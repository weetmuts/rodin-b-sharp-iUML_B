...
public class DiagramsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DiagramsPackage.DIAGRAM: {
				Diagram diagram = (Diagram)theEObject;
				T result = caseDiagram(diagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramsPackage.DIAGRAM_OWNER: {
				DiagramOwner diagramOwner = (DiagramOwner)theEObject;
				T result = caseDiagramOwner(diagramOwner);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
