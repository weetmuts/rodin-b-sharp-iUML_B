...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Statemachine Collection</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link ac.soton.eventb.statemachines.impl.StatemachineCollectionImpl#getStatemachines <em>Statemachines</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StatemachineCollectionImpl extends AbstractExtensionImpl implements StatemachineCollection {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected StatemachineCollectionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StatemachinesPackage.Literals.STATEMACHINE_COLLECTION;
	}
	...
	public EList<AbstractStatemachine> getStatemachines() {
		if (statemachines == null) {
			statemachines = new EObjectContainmentEList<AbstractStatemachine>(AbstractStatemachine.class, this, StatemachinesPackage.STATEMACHINE_COLLECTION__STATEMACHINES);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == StatemachineOwner.class) {
			switch (derivedFeatureID) {
				case StatemachinesPackage.STATEMACHINE_COLLECTION__STATEMACHINES: return StatemachinesPackage.STATEMACHINE_OWNER__STATEMACHINES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == StatemachineOwner.class) {
			switch (baseFeatureID) {
				case StatemachinesPackage.STATEMACHINE_OWNER__STATEMACHINES: return StatemachinesPackage.STATEMACHINE_COLLECTION__STATEMACHINES;
				default: return -1;
			}
		}
