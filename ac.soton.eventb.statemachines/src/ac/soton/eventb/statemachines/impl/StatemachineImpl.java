	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EventBNamed.class) {
			switch (derivedFeatureID) {
				case StatemachinesPackage.STATEMACHINE__NAME: return CorePackage.EVENT_BNAMED__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EventBNamed.class) {
			switch (baseFeatureID) {
				case CorePackage.EVENT_BNAMED__NAME: return StatemachinesPackage.STATEMACHINE__NAME;
				default: return -1;
			}
		}
		if (baseClass == AbstractExtension.class) {
